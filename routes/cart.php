...
Route::post('add-to-cart', [CartController::class, 'store'])->name('frontend.carts.create');
...
Route::post('shopping-cart', [CartController::class, 'delete'])->name('frontend.carts.shopping_cart');
