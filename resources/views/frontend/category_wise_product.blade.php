@extends('layouts.master_layout', ['title' => 'Category wise products'])
@section('content')
    ...
    <section class="product_section mb-3">
        <div class="container-fluid">
                ...
                @forelse ($categories as $cat)
                    <li class="me-4">
                        <a class="navbar_btn btn p-1 text-white text-decoration-none"
                            href="{{ route('frontend.category_wise_product_show', ['id' => $cat->id, 'name' => Str::slug($cat->name)]) }}">
            ...
            <div class="row">
                ...
                @php
                    $hasProduct = false;
                    $category = $category_wise_products;
                @endphp
