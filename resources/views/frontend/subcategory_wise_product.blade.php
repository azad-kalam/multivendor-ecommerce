@extends('layouts.master_layout', ['title' => 'Subcategory wise products'])
@section('content')
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="mx-auto d-flex justify-content-center align-items-center"
                        ...
                        <img src="{{ asset('assets/images/homepage/img/mens.jpg') }}" class="h-100 w-100 rounded"
                            alt="" />
                    </div>
                </div>
    ...
    <section class="product_section mb-3">
        <div class="container-fluid">
            ...
            <div class="dropdown bg-success rounded mb-3">
                ...
                <ul class="dropdown-menu bg-transparent mt-3">
                    @foreach ($categories as $category)
                        @foreach ($category->subcategories as $subcategory)
                            <li>
                                <a href="{{ route('frontend.subcategory_wise_product_show', ['id' => $subcategory->id, 'name' => Str::slug($subcategory->subcategory_name)]) }}"
                                    class="dropdown-item
            ...
            <div class="row">
                @forelse ($subcategory_wise_products->products as $product)
                    <div class="col-md-3 mb-4">
                        <div class="product-card">
                            <div class="product-img">
                                @if ($product->images->first())
                            ...
                            <div class="product-body text-center">
                                <p class="product-category">
                                    {{ $subcategory_wise_products->subcategory_name ?? 'Subcategory Empty' }}
                                </p>

                                <h5 class="product-name">
                                    {{ $product->name ?? 'Product Name Empty' }}
                                </h5>

                                <div class="product-price">
                                    <span class="new-price">
                                        ৳{{ $product->price?->selling_price ?? 'No available' }}
                                    </span>

                                    <span class="old-price">
                                        ৳{{ $product->price?->regular_price ?? 'No available' }}
                                    </span>
                                </div>
                    ...
                    <div class="col-12 text-center my-5">
                        <div class="alert alert-warning d-inline-block">
                            ...
                            <strong class="text-danger">
                                {{ $subcategory_wise_products->subcategory_name }}
                            </strong>
                        </div>
                    </div>
                @endforelse
    ...
    <section class="product_section mb-3">
        <div class="container-fluid">
            ...
            <div class="row">
                @foreach ($brand_products->flatten() as $product)
                    <div class="col-md-3 mb-4">
                        <div class="product-card">
                            <div class="product-img">
                                @if ($product->images->first())
